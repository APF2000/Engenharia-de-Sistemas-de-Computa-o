...
%
\include{tex/1-capa}
%\include{tex/2-folharosto}
%\include{tex/3-folhadeaprovacao}
%\include{tex/4-dedicatoria}
%\include{tex/5-agradecimentos}
%\include{tex/6-epigrafe}
\pagestyle{plain}%%%%% Utilizar ESTILO PLAIN AQUI%%%%%%%
%\include{tex/7-resumo}
%\include{tex/8-abstract}
...
% \let\clearpage\relax
\include{tex/Diagramas-iguais/15-diagramas-uml}
\include{tex/Diagramas-modificados/16-diagramas-modificados}
\include{tex/Diagramas-exclusivos-do-SysML/17-diagramas-exclusivos}
%\include{tex/15-diagramas}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%% Estilo de citação ABNT e arquivo de bibitens (mybibliography.bib)
\bibliographystyle{bib/abnt-alf}
\bibliography{bib/mybibliography}

\apendice
%\include{tex/19-appendices}
